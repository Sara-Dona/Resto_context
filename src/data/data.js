export const restaurants = [
  {
    ...
    description_long:
      "Paradise réunit tous les critères pour un repas réussi : une cuisine gastronomique, récompensée d'une étoile au Guide Michelin, et une vue légendaire sur la célèbre cathédrale de Notre-Dame. Que demander de plus ?",
    img: "/img/food-1.jpg",
    menu: {
      entrees: ["Avocat avec carotte", "Gazpacho à la tomate"],
      dishes: ["Tofu avec frites", "Quiche aux legumes", "Tomatican"],
      deserts: ["Tiramisu", "Mousse fruit de la passion"],
    },
  },
  {
    id: 1,
    name: "Donde Paco",
    address: "75bis rue de l'eau, 75005",
    ...
    img: "/img/food-2.jpg",
    menu: {
      entrees: ["Patatas Bravas", "Empanadas de zetas"],
      dishes: ["Paella de vegetales", "Tortilla espanola", "Risotto de Pesto"],
      deserts: ["Churros con chocolate", "Leche nevada"],
    },
  },
  {
    id: 2,
